...
void rpsl_M_rpsl_triangle_Fn_main(struct texture*) __ATTRIBUTELIST__((nothrow));
...
void rpsl_M_rpsl_triangle_Fn_main_wrapper(uint32_t, uint8_t**, uint32_t) __ATTRIBUTELIST__((noinline, nothrow));


/* Global Variable Definitions and Initialization */
static __MSALIGN__(4) struct l_array_3_struct_AC_l_struct____rpsl_node_info_struct ___rpsl_nodedefs_rpsl_triangle __attribute__((aligned(4))) = { { { 0, 34, 0, 2, 1 }, { 1, 46, 2, 1, 1 }, { 0, 0, 0, 0, 0 } } };
static __MSALIGN__(4) struct l_array_2_struct_AC_l_struct____rpsl_entry_desc_struct ___rpsl_entries_rpsl_triangle __attribute__((aligned(4))) = { { { 0, 55, 3, 1, ((uint8_t*)rpsl_M_rpsl_triangle_Fn_main), ((uint8_t*)rpsl_M_rpsl_triangle_Fn_main_wrapper) }, { 0, 0, 0, 0, ((uint8_t*)/*NULL*/0), ((uint8_t*)/*NULL*/0) } } };
static __MSALIGN__(4) struct l_array_3_struct_AC_l_struct____rpsl_type_info_struct ___rpsl_types_metadata_rpsl_triangle __attribute__((aligned(4))) = { { { 6, 0, 0, 0, 0, 36, 4 }, { 4, 32, 0, 4, 0, 16, 4 }, { 0, 0, 0, 0, 0, 0, 0 } } };
static __MSALIGN__(4) struct l_array_5_struct_AC_l_struct____rpsl_params_info_struct ___rpsl_params_metadata_rpsl_triangle __attribute__((aligned(4))) = { { { 14, 0, 272629888, -1, 0, 36, 0 }, { 16, 1, 0, -1, 0, 16, 36 }, { 21, 0, 128, -1, 0, 36, 0 }, { 60, 0, 524288, -1, 0, 36, 0 }, { 0, 0, 0, 0, 0, 0, 0 } } };
static __MSALIGN__(4) struct l_array_1_struct_AC_l_struct____rpsl_shader_ref_struct ___rpsl_shader_refs_rpsl_triangle __attribute__((aligned(4)));
static __MSALIGN__(4) struct l_array_1_struct_AC_l_struct____rpsl_pipeline_info_struct ___rpsl_pipelines_rpsl_triangle __attribute__((aligned(4)));
static __MSALIGN__(4) struct l_array_1_struct_AC_l_struct____rpsl_pipeline_field_info_struct ___rpsl_pipeline_fields_rpsl_triangle __attribute__((aligned(4)));
static __MSALIGN__(4) struct l_array_1_struct_AC_l_struct____rpsl_pipeline_res_binding_info_struct ___rpsl_pipeline_res_bindings_rpsl_triangle __attribute__((aligned(4)));
__MSALIGN__(4) struct l_array_71_uint8_t ___rpsl_string_table_rpsl_triangle __attribute__((aligned(4))) = { { 114u, 112u, 115u, 108u, 95u, 116u, 114u, 105u, 97u, 110u, 103u, 108u, 101u, 0, 116u, 0, 100u, 97u, 116u, 97u, 0, 114u, 101u, 110u, 100u, 101u, 114u, 84u, 97u, 114u, 103u, 101u, 116u, 0, 99u, 108u, 101u, 97u, 114u, 95u, 99u, 111u, 108u, 111u, 114u, 0, 84u, 114u, 105u, 97u, 110u, 103u, 108u, 101u, 0, 109u, 97u, 105u, 110u, 0, 98u, 97u, 99u, 107u, 98u, 117u, 102u, 102u, 101u, 114u, 0 } };
__CBE_DLLEXPORT__ __MSALIGN__(4) struct l_struct____rpsl_module_info_struct ___rpsl_module_info_rpsl_triangle __attribute__((aligned(4))) = { 1297305682u, 3, 9, 0, 71, 2, 2, 4, 1, 0, 0, 0, 0, (&___rpsl_string_table_rpsl_triangle), (&___rpsl_nodedefs_rpsl_triangle), (&___rpsl_types_metadata_rpsl_triangle), (&___rpsl_params_metadata_rpsl_triangle), (&___rpsl_entries_rpsl_triangle), (&___rpsl_shader_refs_rpsl_triangle), (&___rpsl_pipelines_rpsl_triangle), (&___rpsl_pipeline_fields_rpsl_triangle), (&___rpsl_pipeline_res_bindings_rpsl_triangle), 1297305682u };
...
__CBE_DLLEXPORT__ struct l_array_2_struct_AC_l_struct_struct_OC_RpsNodeDesc NodeDecls_rpsl_triangle = { { { 1, 2, ((&_AE__AE_rps_ParamDescArray5.array[((int32_t)0)])), ((&_AE__AE_rps_Str0.array[((int32_t)0)])) }, { 1, 1, ((&_AE__AE_rps_ParamDescArray9.array[((int32_t)0)])), ((&_AE__AE_rps_Str6.array[((int32_t)0)])) } } };
...
struct l_struct_struct_OC_RpslEntry rpsl_M_rpsl_triangle_E_main_AE_value = { ((&_AE__AE_rps_Str10.array[((int32_t)0)])), rpsl_M_rpsl_triangle_Fn_main_wrapper, ((&_AE__AE_rps_ParamDescArray13.array[((int32_t)0)])), ((&NodeDecls_rpsl_triangle.array[((int32_t)0)])), 1, 2 };
__CBE_DLLEXPORT__ struct l_struct_struct_OC_RpslEntry* rpsl_M_rpsl_triangle_E_main = (&rpsl_M_rpsl_triangle_E_main_AE_value);
__CBE_DLLEXPORT__ struct l_struct_struct_OC_RpslEntry** rpsl_M_rpsl_triangle_E_main_pp = (&rpsl_M_rpsl_triangle_E_main);
...
#line 3 "rpsl_triangle.rpsl"
void rpsl_M_rpsl_triangle_Fn_main(struct texture* backbuffer) {
...
#line 3 "rpsl_triangle.rpsl"
void rpsl_M_rpsl_triangle_Fn_main_wrapper(uint32_t llvm_cbe_temp__39, uint8_t** llvm_cbe_temp__40, uint32_t llvm_cbe_temp__41) {

  struct {
    uint8_t* _42;
    struct ResourceDesc* _43;
    struct texture* _44;
    uint32_t* _45;
    struct texture* _46;
    uint32_t _47;
  ...
  struct {
    struct texture* _48;
    struct texture* _48__PHI_TEMPORARY;
  } _llvm_cbe_phi_tmps = {0};

#line 3 "rpsl_triangle.rpsl"
#line 3 "rpsl_triangle.rpsl"
  if ((((llvm_cbe_temp__39 == 1u)&1))) {
#line 3 "rpsl_triangle.rpsl"
    goto trunk;
#line 3 "rpsl_triangle.rpsl"
  } else {
...
trunk:
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._42 = *((&(*llvm_cbe_temp__40)));
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._43 = ((struct ResourceDesc*)_llvm_cbe_tmps._42);
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._44 = (struct texture*) alloca(sizeof(struct texture));
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._45 = (uint32_t*) alloca(sizeof(uint32_t));
#line 3 "rpsl_triangle.rpsl"
  *_llvm_cbe_tmps._45 = 0;
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._46 = ((struct texture*)_llvm_cbe_tmps._42);
#line 3 "rpsl_triangle.rpsl"
  if ((((((bool)(llvm_cbe_temp__41 & 1)&1u))&1))) {
#line 3 "rpsl_triangle.rpsl"
    _llvm_cbe_phi_tmps._48__PHI_TEMPORARY = _llvm_cbe_tmps._46;   /* for PHI node */
#line 3 "rpsl_triangle.rpsl"
    goto llvm_cbe_temp__49;
#line 3 "rpsl_triangle.rpsl"
  } else {
#line 3 "rpsl_triangle.rpsl"
    goto _2e_preheader;
...
llvm_cbe_temp__50:
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_tmps._47 = *_llvm_cbe_tmps._45;
#line 3 "rpsl_triangle.rpsl"
#line 3 "rpsl_triangle.rpsl"
  if ((((((int32_t)_llvm_cbe_tmps._47) < ((int32_t)1u))&1))) {
#line 3 "rpsl_triangle.rpsl"
...
llvm_cbe_temp__51:
#line 3 "rpsl_triangle.rpsl"
  *(((&_llvm_cbe_tmps._44[((int32_t)_llvm_cbe_tmps._47)]))) = _BA__PD_make_default_texture_view_from_desc_AE__AE_YA_PD_AUtexture_AE__AE_IUResourceDesc_AE__AE__AE_Z((llvm_add_u32(_llvm_cbe_tmps._47, 0)), ((&_llvm_cbe_tmps._43[((int32_t)_llvm_cbe_tmps._47)])));
#line 3 "rpsl_triangle.rpsl"
  *_llvm_cbe_tmps._45 = (llvm_add_u32(_llvm_cbe_tmps._47, 1));
#line 3 "rpsl_triangle.rpsl"
  goto llvm_cbe_temp__50;
#line 3 "rpsl_triangle.rpsl"
...
_2e_loopexit:
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_phi_tmps._48__PHI_TEMPORARY = _llvm_cbe_tmps._44;   /* for PHI node */
#line 3 "rpsl_triangle.rpsl"
  goto llvm_cbe_temp__49;
#line 3 "rpsl_triangle.rpsl"
...
llvm_cbe_temp__49:
#line 3 "rpsl_triangle.rpsl"
  _llvm_cbe_phi_tmps._48 = _llvm_cbe_phi_tmps._48__PHI_TEMPORARY;
#line 3 "rpsl_triangle.rpsl"
  rpsl_M_rpsl_triangle_Fn_main(_llvm_cbe_phi_tmps._48);
#line 3 "rpsl_triangle.rpsl"
}
