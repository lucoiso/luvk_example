...
void luvk_example::InputManager::BindEvent(
    const Uint32 Type, std::function<void(SDL_Event const &)> const &Callback) {
...
void luvk_example::InputManager::InvokeCallbacks(const Uint32 Type,
...
bool luvk_example::InputManager::IsKeyPressed(
    const SDL_Keycode key) const noexcept {
